...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const res = await axios.post("http://localhost:3001/mail", {
        name: name,
        mail: mail,
        msg: msg,
      });
        ...
        <div className="contact-section">
          <div className="contact-left">
            ...
            <p style={{ textAlign: "center" }}>
              ...
              . Feel free to reach out to me anytime to discuss potential
              opportunities.
            </p>
            ...
            >
              <LinkedInIcon
                id="linkedIcon"
                onClick={() => {
                  window.open("https://www.linkedin.com/in/yadharth/");
                }}
              />
              <GitHubIcon
                id="githubIcon"
                onClick={() => {
                  window.open("https://github.com/YadharthGC");
                }}
              />
            </div>
          </div>
